import type { VisiMisi, Branch, Ketua, Bidang, Pengurus, News } from "@/types";
...
export const bidangPengurus: Bidang[] = [
  { name: "Bidang Sosial", desc: "Bakti sosial, pengobatan gratis, bantuan bencana" },
  { name: "Bidang Humas & HLP", desc: "Hubungan masyarakat dan relasi antar lembaga" },
  { name: "Bidang Ekonomi & HLN", desc: "Pemberdayaan UMKM, kerja sama ekonomi, investasi" },
  { name: "Bidang Pendidikan & Seni Budaya", desc: "Program beasiswa, pelestarian seni budaya Tionghoa-Indonesia" },
  { name: "Bidang IT, Sosmed & Multimedia", desc: "Website, media sosial, dan publikasi digital" },
  { name: "Bidang Hukum & Organisasi", desc: "Advokasi hukum, konsolidasi, dan kaderisasi organisasi" },
  { name: "Bidang Pemuda & Olah Raga", desc: "Pembinaan generasi muda dan kegiatan olahraga" },
  { name: "Bidang Lain-Lain", desc: "Program dan kegiatan di luar bidang utama" },
];
